...
export default function SettingsScreen() {
  ...
  const handleSeedExercises = useCallback(async () => {
    ...
    if (success) {
      Alert.alert(
        "Success",
        "Seeded exercises successfully! App will refresh.",
      );
      loadAvailableExercises();
    } else {
      Alert.alert(
        "Seeding Failed",
        "Unable to seed, as u already have exercises.",
      );
    }
  }, [loadAvailableExercises]);
        ...
        { text: "No", style: "cancel" },
        {
          ...
          onPress: async () => {
            ...
            if (success) {
              Alert.alert(
                "Success",
                "All data cleared successfully! App will refresh.",
              );
              loadAvailableExercises();
            } else {
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.section, { backgroundColor: colors.surface }]}>
        ...
        <View style={styles.appearanceRow}>
          <Text
            style={[styles.appearanceLabel, { color: colors.textSecondary }]}
          >
            Dark Mode
          </Text>
          <Switch
        ...
        <View style={styles.settingsRow}>
          ...
          >
            <Ionicons
              ...
              color="#FFFFFF"
            />
            <Text style={styles.buttonText}>Import Default Exercises</Text>
          </TouchableOpacity>
        </View>
      </View>
        ...
        <View style={styles.settingsRow}>
          <TouchableOpacity
            ...
            style={[
              ...
              exportLoading && styles.buttonDisabled,
            ]}
            disabled={exportLoading}
          >
            {exportLoading ? (
          ...
          <TouchableOpacity
            ...
            style={[
              styles.button,
              { backgroundColor: colors.primaryAction },
              importLoading && styles.buttonDisabled,
            ]}
